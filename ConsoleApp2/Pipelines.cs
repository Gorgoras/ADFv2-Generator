    ...
    static class Pipelines
    {
        public static void menu(DataFactoryManagementClient client)
        {
            ...
            while (opcion != 9)
            {
                ...
                Console.Write("4. Correr pipe a mano\n");
                Console.Write("5. Listar pipelines\n");
                Console.Write("6. Crear pipe llamar SSIS (test!)\n");
                Console.Write("7. Corregir pipes (tratar con cuidado!)\n");
                Console.Write("8. Eliminar pipes\n");
        ...
        {
            bool es = false;
            string nombre = v.Substring(3); //saco el schema y me quedo solo con el nombre de la tabla
        ...
        {
            string nombreTabla = "dbo-cc_activity";
            string nombreTablaParaCompresion = "cc_activity";
            string tabla = "dbo.cc_activity";
            List<Activity> la;
            CopyActivity ca;
            List<DatasetReference> inp;
            DatasetReference dr;
            ...
            string consultaNueva = DatosGrales.queryMagica(tabla, 100000);
